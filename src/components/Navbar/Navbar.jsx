...
const [theme, setTheme] = useState(
  isLocalStorageAvailable && localStorage.getItem("theme") ? localStorage.getItem("theme") : "light"
);
            ...
            {liList.map((li) => {
              ...
              return (
                <li className={style.li_style} key={li.id}>
                  <Link
                    className={isActive ? `${style.active_class}` : theme==='dark'? `${style.normal_text}` :'text-black'}
                    href={`${li.link}`}
                  >
                    {li.title}
                  </Link>
